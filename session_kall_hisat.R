getwd()
setwd("C:/Users/kaimenyi/Documents/module2_R_biostats-master/module_4/")
...
bg = ballgown(dataDir = "Hisat/", samplePattern = "1", pData=pheno_data)
...
dim(bg_filt_table)
head(bg_filt_table)
# identify transcripts that show statistically significant differences between root and spike
